    ...
    myDiagram.nodeTemplateMap.add(
      ...
      $(
        ...
        $(
          ...
          $(go.RowColumnDefinition, { column: 1, width: 0 }),
          $(go.TextBlock, "埋点日志", { row: 0, column: 0 }),
          $(go.TextBlock, "说明：", { row: 1, column: 0 }),
          $(
            go.TextBlock,
            "",
            {
          ...
          $(go.TextBlock, "参数：", { row: 2, column: 0 }),
          $(
            go.TextBlock,
            "参数内容",
            {
